...
public class OrthanaStairsBlock extends NeworesModElements.ModElement {
	@ObjectHolder("newores:orthana_stairs")
	public static final Block block = null;
	public OrthanaStairsBlock(NeworesModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orthana_stairs");
		}
