...
public class OrthanaFenceBlock extends NeworesModElements.ModElement {
	@ObjectHolder("newores:orthana_fence")
	public static final Block block = null;
	public OrthanaFenceBlock(NeworesModElements instance) {
		super(instance, 22);
	}
